...
plt.xlim([-1.5, 1])
plt.ylim([-2, 1.5])
plt.scatter(Y_fg[:, 0], Y_fg[:, 1], c=tableau10[X_r["partyid"].iloc[0]], label=party[X_r["partyid"].iloc[0]], alpha=0.8, linewidths=0)
...
plt.show()
f.savefig("cMCA_CCES2015_repdem_org.pdf", bbox_inches='tight')
