...
for label in X_lab['pro_eu'].unique():
    plt.scatter(Y_fg[X_lab['pro_eu'] == label, 0], Y_fg[X_lab['pro_eu'] == label, 1], c=tableau10[label], label=label, alpha=0.3, linewidths=0)
...
plt.show()
f_2.savefig("cMCA_ESS2018_labuip_new.pdf", bbox_inches='tight')
