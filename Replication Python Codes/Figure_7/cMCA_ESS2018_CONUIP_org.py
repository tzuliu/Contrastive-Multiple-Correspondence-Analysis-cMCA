...
plt.xlim([-1, 5.5])
plt.ylim([-1, 2.5])
plt.scatter(Y_fg[:, 0], Y_fg[:, 1], c=tableau10["pink"], label=party[X_con["prtclcgb"].iloc[0]], alpha=0.8, linewidths=0)
...
plt.xlabel('cPC1')
plt.ylabel('cPC2')
plt.title("cMCA (tg: CON, bg: UKIP, " + str(alpha) + ": 100)")
plt.show()
f_3.savefig("cMCA_ESS2018_conuip_org.pdf", bbox_inches='tight')
