...
for label in X_r['rep_con'].unique():
    plt.scatter(Y_fg[X_r['rep_con'] == label, 0], Y_fg[X_r['rep_con'] == label, 1], c=tableau10[label], label=label, alpha=0.6, linewidths=0)
...
plt.show()
f.savefig("cMCA_CCES2015_repdem_new2.pdf", bbox_inches='tight')
