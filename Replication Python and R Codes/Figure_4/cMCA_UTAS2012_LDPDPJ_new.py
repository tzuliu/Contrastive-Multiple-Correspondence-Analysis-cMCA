...
for label in X_ldp['anti_asia'].unique():
    plt.scatter(Y_fg[X_ldp['anti_asia'] == label, 0], Y_fg[X_ldp['anti_asia'] == label, 1], c=tableau10[label], label=label, alpha=0.3, linewidths=0)
...
plt.show()
f.savefig("cMCA_UTAS2012_ldpdpj_new.pdf", bbox_inches='tight')
